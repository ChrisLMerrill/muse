...
public class CompoundPluginConfiguration extends GenericResourceConfiguration implements TestPluginConfiguration
	{
	@Override
	...
	public static class CompoundPluginType extends ResourceSubtype
		...
		public CompoundPluginType()
			{
			super(TYPE_ID, "List of Plugins", CompoundPluginConfiguration.class, new TestPluginConfigurationResourceType());
			}
		}
	}
