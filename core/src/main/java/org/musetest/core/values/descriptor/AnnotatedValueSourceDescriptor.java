...
public class AnnotatedValueSourceDescriptor extends DefaultValueSourceDescriptor
    ...
    @Override
    public String getShortDescription(ValueSourceConfiguration config)
        {
        MuseValueSourceDescription description_annotation = (MuseValueSourceDescription) _source_class.getAnnotation(MuseValueSourceDescription.class);
