...
@MuseSubsourceDescriptor(displayName = "Name Group", description = "Index of the capture group containing the name. Default is 1.", type = SubsourceDescriptor.Type.Named, name = FindNvpByRegexSource.NAME_GROUP_PARAM, defaultValue = "1", optional = true)
@MuseSubsourceDescriptor(displayName = "Value Group", description = "Index of the capture group containing the value. Default is 2.", type = SubsourceDescriptor.Type.Named, name = FindNvpByRegexSource.VALUE_GROUP_PARAM, defaultValue = "2", optional = true)
@MuseSubsourceDescriptor(displayName = "Match index", description = "Index of the match to create the NVP from. Default is 0.", type = SubsourceDescriptor.Type.Named, name = FindNvpByRegexSource.MATCH_INDEX_PARAM, defaultValue = "0", optional = true)
