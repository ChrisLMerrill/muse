...
public class ConditionalAndLoopingTests
    ...
    public void testIfStep()
        ...
        will_run.setSource("condition", condition);
        StepConfiguration should_run_step = new StepConfiguration(LogMessage.TYPE_ID);
        final String should_run_message = "it ran";
        should_run_step.setSource(LogMessage.MESSAGE_PARAM, ValueSourceConfiguration.forValue(should_run_message));
        ...
        wontrun.setSource("condition", condition);
        ...
        should_not_run_step.setSource(LogMessage.MESSAGE_PARAM, ValueSourceConfiguration.forValue(should_not_run_message));
    ...
    private SteppedTest createLoopTest(String counter_var_name, String message_prefix, Object initial_value)
        ...
        store_step.setSource(StoreVariable.NAME_PARAM, ValueSourceConfiguration.forValue(counter_var_name));
        store_step.setSource(StoreVariable.VALUE_PARAM, ValueSourceConfiguration.forValue(initial_value));
        ...
        while_step.setSource(WhileStep.CONDITION_PARAM, condition);

        StepConfiguration increment_step = new StepConfiguration(IncrementVariable.TYPE_ID);
        increment_step.setSource(IncrementVariable.NAME_PARAM, ValueSourceConfiguration.forValue(counter_var_name));
        ...
        log_step.setSource(LogMessage.MESSAGE_PARAM, config);
